...
\initunifonts
%\pgbackground{\picheight=\pageheight \inspic{rogers2.jpg}}
%\pgbackground{\picheight=\pageheight \inspic{grid.pdf}}

\font\ebgaramond "EBGaramond12-Regular":+tlig; at 12pt\ebgaramond
\font\ebgaramondit "EBGaramond12-Italic":+tlig; at 12pt
\font\ebgaramondXIV "EBGaramond12-Regular":letterspace=12;+lnum; at 14pt

\font\ebgXVIII "EBGaramond12-Regular":letterspace=12; at 18pt
\font\ebgscXVIII "EBGaramond12-Regular":letterspace=12;+smcp;+cv11; at 18pt
\font\corgaramond "CormorantGaramond-Light" at 56pt

%\baselineskip=15.75pt
\baselineskip=15pt
\topskip=1em
...
\frenchspacing
\footline{\hss \ebgaramond\folio\hss}

\def\emph#1{{\ebgaramondit #1}}
...
\leavevmode \par %2
\leavevmode \par %4
\centerline{\smash{\ebgscXVIII arc 1}} %3

\leavevmode \par %5
\centerline{\smash{\ebgXVIII GESTATION}} %6
\leavevmode \par %7
\leavevmode \par %8
\leavevmode \par %9
\leavevmode \par %10
\vskip\baselineskip
%{\Red x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x}\par
%\noindent\rlap{{\Red x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x x}}%
\centerline{%
	\smash{%
		\raise1ex\hbox{%
			\ebgaramondXIV 
...
\noindent\kern-0.2em\smash{\corgaramond C}%
lass ended in five minutes and all I could think was, \emph{an hour is too long for lunch}.
